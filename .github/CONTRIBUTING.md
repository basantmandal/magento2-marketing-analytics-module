...
# Contributing to HK2 Marketing Analytics

**First off, thank you for considering contributing to the HK2 Marketing Analytics Module! It's people like you that make it such a great tool.**
...
Welcome to the **HK2 Marketing Analytics** contributing guide! This document provides guidelines and instructions for contributing to this Magento 2 extension.
...
```text
app/code/HK2/Marketing Analytics/
├── Controller/
├── etc/
├── Model/
├── view/
